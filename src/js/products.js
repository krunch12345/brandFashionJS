...
const renderProduct = (product) => {
    return `<div class="products-item">
                <div class="for-add-cart-btn">
                    <img class="products-item-photo" src="${product.img}" alt="products-item-${product.id}" height="420">
                ...
                <a href="product.html" class="products-link">
                    <span class="products-item-title">${product.title}</span>
...
const renderPage = list => {
    ...
    document.querySelector('.products-block').innerHTML = productsList
}
